		...
		<div class="row row-offcanvas row-offcanvas-left">
			...
			<div class="panel-heading">
				<div class="row">
                    ...
                    <button type="button" id="addCategory" class="btn btn-info btn-sm" title="Add user" style="background-color: blue; color: white;" onclick="location.href='class/categoradd.php';"><span class="glyphicon glyphicon-plus"></span> Ajouter</button>
			...
			<table id="categoryListing" class="table table-striped table-bordered">
				...
				<tbody>
                       <?php
                            ...
                            <td>
                                <a class='btn btn-warning btn-xs update' href='#'>Modifier</a> </td>
                                <td>
                
                                <a class='btn btn-danger btn-xs delete' href='/cultur/delet/deletcaegory.php?categoryid=$row[categoryid]'>Supprimer</a>
                            </td>
                        </tr>
                                ";
