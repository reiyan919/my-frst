...
<body>
       ...
       <section class="oeti">
        ...
        <div class="container2">
          <div class="section-title">
            <h2>Ordinateur et informations</h2>
    ...
    $category = 'Ordinateur et informations';
    $sql = "SELECT * FROM book WHERE categoryid = 'Ordinateur et informations'";
...
<?php
        ...
        echo "No books found in the 'Ordinateur et informations' category.";
      }
    } else {
